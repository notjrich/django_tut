...
def create_question(question_text, days):
    ...
    offset to now (negative for question published in the past, poslitive for quesitons that 
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_past_question(self):
        """
        Questions with a pub_date in the past should be dispalyed on the index page.
        """
    ...
    def test_index_view_with_future_question_and_past_question(self):
        """
        Even if both past and future questions exist, only past question should be displayed.
        """
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detaiol_view_with_a_past_question(self):
        """
